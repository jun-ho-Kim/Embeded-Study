...
#define TIMER_START             _IO(IOCTLTEST_MAGIC, 1) 
#define TIMER_VALUE             _IOW(IOCTLTEST_MAGIC, 2,ioctl_test_info)
...
//#define TIMER_STOP              _IO(IOCTLTEST_MAGIC, 9)
//#define TIMER_START             _IO(IOCTLTEST_MAGIC, 10) 
//#define TIMER_VALUE             _IOR(IOCTLTEST_MAGIC, 11,ioctl_test_info)

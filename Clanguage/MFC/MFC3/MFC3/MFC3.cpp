...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_COMMAND(ID_DRAWBOX, &CAboutDlg::OnDrawbox)
	ON_COMMAND(ID_THREAD_START, &CAboutDlg::OnThreadStart)
	ON_COMMAND(ID_THREAD_END, &CAboutDlg::OnThreadEnd)
END_MESSAGE_MAP()
...
void CAboutDlg::OnThreadStart()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
}


void CAboutDlg::OnThreadEnd()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
}

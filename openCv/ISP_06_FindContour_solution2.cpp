...
void main()
{
	...
	for (size_t i = 0; i < contours.size(); i++)
	{
		...
		//putText(src_color, msg, rt.boundingRect().tl(), HersheyFonts::FONT_HERSHEY_SIMPLEX, 0.4, Scalar(120, 0, 255), 1);

		//msg = std::format("[{}]-A {}-L {}", i, (int)area, (int)length);
		//putText(src_color, msg, Point(10, 50+txt_index*20), HersheyFonts::FONT_HERSHEY_SIMPLEX, 0.4, Scalar(20, 20, 20), 1);
		//txt_index++;

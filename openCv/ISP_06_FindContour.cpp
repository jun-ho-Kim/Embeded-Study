...
void main()
{
	...
	// Get Parameters HSV for OpenCV - long,png
...
// Green : H 45, 100
	...
	//reduced_R = reduced_R & detect_img_R;
	...
	for (size_t i = 0; i < contours.size(); i++)
	{
		...
		//cv::drawMarker(src_color, center, Scalar(0,255,255), MarketTypes::MARKER_)
		...
		//Scalar color = Scalar(rng.uniform(0,256). rng.
	...
	bitwise_and(); // 오리지널 데이터에 대해서 찾은 원본에 대해 마스킹하여 데이터를 가져옴
	imgAnd = imgA & imgB; // Error
	*/
	//Detect Shape
	// Green : H 45, 100
	// Blue : H 60, 120
	...
	drawContours(src_color, contours, (int)max_index, Scalar(255,255,255), 1, LINE_8, hierarchy, 0);

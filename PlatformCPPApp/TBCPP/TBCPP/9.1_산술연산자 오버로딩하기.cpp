...
int main()
{
	...
	//일반적인 함수, friend 함수(1. 클래스 밖에 선언 2. definition을 클래스 안으로 구현) 멤버 함수로 구현

	// 주의사항: 멤버 함수로 연산자 오버로딩을 했는데 멤버로만 해야하는 연산자도 있다.
	//// =, [], (), -> 은 멤버함수로만 오버로딩을 해야한다.
	// ㄴ 이런 경우에는 외우기 보다는 구글을 검색하거나 컴파일러와 소통하면서 코딩하는 것이 좋다.

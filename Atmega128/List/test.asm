...
; .FSTART _main
; 0000 001E     int i;
; 0000 001F     unsigned char led= 0xff;
...
; 0000 003D DDRE=(0<<DDE7) | (0<<DDE6) | (0<<DDE5) | (0<<DDE4) | (0<<DDE3) | (0<<DDE2) | (0<<DDE1) | (0<<DDE0);
	OUT  0x2,R30
...
; 0000 0043 DDRF=(0<<DDF7) | (0<<DDF6) | (0<<DDF5) | (0<<DDF4) | (0<<DDF3) | (0<<DDF2) | (0<<DDF1) | (0<<DDF0);
	STS  97,R30
...
_0x3:
; 0000 00C7       {
; 0000 00C8       if(PIND.0==0)
	SBIC 0x10,0
	RJMP _0x6
; 0000 00C9       {
; 0000 00CA         led=0xfe;
	LDI  R19,LOW(254)
; 0000 00CB         for(i=0; i<8;i++)
	__GETWRN 16,17,0
_0x8:
	__CPWRN 16,17,8
	BRGE _0x9
; 0000 00CC         {
; 0000 00CD             PORTB=led; delay_ms(300); led=(led<<1|0x01);
	RCALL SUBOPT_0x0
	LSL  R30
	ORI  R30,1
	MOV  R19,R30
...
_0x9:
; 0000 00CF       }
; 0000 00D0       else{ PORTB = 0xff;  }
	RJMP _0xA
_0x6:
	LDI  R30,LOW(255)
	OUT  0x18,R30
_0xA:
; 0000 00D1       if(PIND.1==0)
	SBIC 0x10,1
	RJMP _0xB
; 0000 00D2       {
; 0000 00D3       led=0x7f;
	LDI  R19,LOW(127)
; 0000 00D4         for(i=0;i<8;i++)
	__GETWRN 16,17,0
_0xD:
	__CPWRN 16,17,8
	BRGE _0xE
; 0000 00D5         {
; 0000 00D6             PORTB=led; delay_ms(300); led=(led>>1|0x80) ;
	RCALL SUBOPT_0x0
	LSR  R30
	ORI  R30,0x80
	MOV  R19,R30

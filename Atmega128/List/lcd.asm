...
_0x3:
	.DB  0x41,0x49,0x6F,0x74,0x20,0x43,0x6C,0x61
	.DB  0x73,0x73,0x21,0x21,0x21,0x21,0x21,0x0
...
_0x0:
	...
	.DB  0x44,0x61,0x74,0x61,0x3D,0x20,0x25,0x35
	.DB  0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00E0 lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00E1 lcd_putsf("Welcome");   // 플래시 메모리에 저장(문자열은 플래시 메모리에 넣었다가 가져옴)
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00E2 // lcd는 16비트는 보이는 영역 나머지 16비트는 보이지 않는 영역을 사용(비트 연산 시프트를 하니 위해서)

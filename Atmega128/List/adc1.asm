...
_0x0:
	.DB  0x61,0x2F,0x64,0x20,0x74,0x65,0x73,0x74
	.DB  0x2E,0x2E,0x0,0x56,0x52,0x3D,0x25,0x64
	.DB  0x2C,0x25,0x34,0x2E,0x32,0x66,0x5B,0x56
	.DB  0x5D,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0037 delay_us(10);
	__DELAY_USB 53
; 0000 0038 #asm
; 0000 0039     in   r30,mcucr
    in   r30,mcucr
; 0000 003A     cbr  r30,__sm_mask
    cbr  r30,__sm_mask
; 0000 003B     sbr  r30,__se_bit | __sm_adc_noise_red
    sbr  r30,__se_bit | __sm_adc_noise_red
; 0000 003C     out  mcucr,r30
    out  mcucr,r30
; 0000 003D     sleep
    sleep
; 0000 003E     cbr  r30,__se_bit
    cbr  r30,__se_bit
; 0000 003F     out  mcucr,r30
    out  mcucr,r30
; 0000 0040 #endasm
; 0000 0041 return adc_data;
	MOV  R30,R5
	RJMP _0x2080002
; 0000 0042 }
; .FEND
...
; 0000 0047     unsigned char adc_1, adc_2;
; 0000 0048     char data[80];
...
; 0000 00D0 // USART0 Receiver: On
; 0000 00D1 // USART0 Transmitter: On
; 0000 00D2 // USART0 Mode: Asynchronous
; 0000 00D3 // USART0 Baud Rate: 9600
; 0000 00D4 UCSR0A=(0<<RXC0) | (0<<TXC0) | (0<<UDRE0) | (0<<FE0) | (0<<DOR0) | (0<<UPE0) | (0<<U2X0) | (0<<MPCM0);
	OUT  0xB,R30
; 0000 00D5 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (1<<RXEN0) | (1<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 00D6 UCSR0C=(0<<UMSEL0) | (0<<UPM01) | (0<<UPM00) | (0<<USBS0) | (1<<UCSZ01) | (1<<UCSZ00) | (0<<UCPOL0);
	LDI  R30,LOW(6)
	STS  149,R30
; 0000 00D7 UBRR0H=0x00;
	LDI  R30,LOW(0)
	STS  144,R30
; 0000 00D8 UBRR0L=0x67;
	LDI  R30,LOW(103)
	OUT  0x9,R30
; 0000 00D9 
; 0000 00DA // USART1 initialization
; 0000 00DB // USART1 disabled
; 0000 00DC UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	LDI  R30,LOW(0)
	STS  154,R30
; 0000 00DD 
...
; 0000 00E7 // ADC Clock frequency: 1000.000 kHz
; 0000 00E8 // ADC Voltage Reference: AREF pin
; 0000 00E9 // Only the 8 most significant bits of
; 0000 00EA // the AD conversion result are used
; 0000 00EB ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 00EC ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (1<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(140)
	OUT  0x6,R30
...
; 0000 00FA // RS - PORTC Bit 0
; 0000 00FB // RD - PORTC Bit 1
; 0000 00FC // EN - PORTC Bit 2
; 0000 00FD // D4 - PORTC Bit 4
; 0000 00FE // D5 - PORTC Bit 5
; 0000 00FF // D6 - PORTC Bit 6
; 0000 0100 // D7 - PORTC Bit 7
...
_0x3:
; 0000 010C       {
; 0000 010D       // Place your code here
; 0000 010E         PORTB = 0xaa;
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x1
; 0000 010F         delay_ms(100);
; 0000 0110         adc_1 = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOV  R17,R30
; 0000 0111         lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 0112         sprintf(data,"VR=%d,%4.2f[V]", adc_1, adc_1*0.02); // , %4.2f // , adc_16t*0.005
	RCALL SUBOPT_0x2
	MOV  R30,R17
	RCALL SUBOPT_0x3
	MOV  R30,R17
	RCALL SUBOPT_0x4
; 0000 0113 
; 0000 0114         lcd_puts(data);
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 0115 
; 0000 0116 
; 0000 0117 
; 0000 0118         PORTB = 0x55;
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x1
; 0000 0119         delay_ms(100);
; 0000 011A         adc_2 = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOV  R16,R30
; 0000 011B         lcd_gotoxy(0,1);
	RCALL SUBOPT_0x5
; 0000 011C         sprintf(data,"VR=%d,%4.2f[V]", adc_2, adc_2*0.02); // , %4.2f // , adc_16t*0.005
	RCALL SUBOPT_0x2
	MOV  R30,R16
	RCALL SUBOPT_0x3
	MOV  R30,R16

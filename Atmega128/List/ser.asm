...
_0x0:
	.DB  0x43,0x6F,0x6E,0x6E,0x65,0x63,0x74,0x20
	.DB  0x73,0x75,0x63,0x65,0x73,0x73,0xA,0xD
	.DB  0x0,0x50,0x72,0x65,0x73,0x73,0x20,0x63
	.DB  0x20,0x6F,0x72,0x20,0x64,0xA,0xD,0x0
	.DB  0x43,0x6F,0x6D,0x6D,0x61,0x6E,0x64,0x5B
	.DB  0x25,0x33,0x64,0x5D,0xA,0xD,0x0,0x25
	.DB  0x63,0x0,0x25,0x63,0x2D,0x3E,0x6F,0x6B
	.DB  0x0
__RESET:
	CLI
	CLR  R30
...
_main:
; .FSTART _main
; 0000 0022 unsigned char led = 0xfe;
; 0000 0023 int i = 0;
; 0000 0024 char temp;
...
; 0000 00CF TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	STS  116,R30
; 0000 00D0 
; 0000 00D1 // 메세지를 누르면 connect reset 메세지 출력
; 0000 00D2 //
; 0000 00D3 printf("Connect sucess\n\r");
	__POINTW1FN _0x0,0
	RCALL SUBOPT_0x0
; 0000 00D4 printf("Press c or d\n\r");
	__POINTW1FN _0x0,17
	RCALL SUBOPT_0x0
; 0000 00D5 
; 0000 00D6 while (1)
...
; 0000 00D9       if(PIND.0==0)
	SBIC 0x10,0
	RJMP _0x6
; 0000 00DA       {
; 0000 00DB         printf("Command[%3d]\n\r", temp);
	__POINTW1FN _0x0,32
	RCALL SUBOPT_0x1
; 0000 00DC       }
; 0000 00DD       else
...
; 0000 00DF       scanf("%c", &temp);
	...
	ADIW R28,6
	POP  R16
; 0000 00E0       printf("%c->ok", temp);
	__POINTW1FN _0x0,50
	RCALL SUBOPT_0x1
; 0000 00E1       switch(temp)
	MOV  R30,R16
	LDI  R31,0
; 0000 00E2       {
; 0000 00E3         case 'a':
...
_0xF:
	...
	BRGE _0x10
; 0000 00E8             {
; 0000 00E9                 PORTB=led; delay_ms(300); led=(led<<1|0x01);
	RCALL SUBOPT_0x2
	LSL  R30
	ORI  R30,1
	MOV  R17,R30
...
; 0000 00F0             led=0x7f;
	LDI  R17,LOW(127)
; 0000 00F1             for(i=0;i<8;i++)
	__GETWRN 18,19,0
_0x15:
	__CPWRN 18,19,8
	BRGE _0x16
; 0000 00F2             {
; 0000 00F3                 PORTB=led; delay_ms(300); led=(led>>1|0x80);
	RCALL SUBOPT_0x2
	LSR  R30
	ORI  R30,0x80
	MOV  R17,R30
...
_0x18:
; 0000 00F9         {
; 0000 00FA             for(i=0;i<8;i++)
	__GETWRN 18,19,0
_0x1B:
	__CPWRN 18,19,8
	BRGE _0x1C
; 0000 00FB             {
; 0000 00FC                 PORTB=0xaa; delay_ms(100);  PORTB=0x55; delay_ms(100);
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x3
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x3
...
; 0000 00FE             break;
	RJMP _0xA
; 0000 00FF         }
; 0000 0100         default: PORTB=led;
_0x1D:
	OUT  0x18,R17
; 0000 0101 
; 0000 0102       }
_0xA:
; 0000 0103       //if(temp=='d') led = 0xaa;
; 0000 0104       //if(temp=='c') led = 0x55;
; 0000 0105       }
_0x7:
; 0000 0106         //PORTB=led;
; 0000 0107       }

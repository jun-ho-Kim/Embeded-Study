...
_0x4:
	...
	BRGE _0x5
; 0000 0022     {
; 0000 0023         PORTB = 0x55;
	LDI  R30,LOW(85)
	RCALL SUBOPT_0x1
; 0000 0024         delay_ms(100);
; 0000 0025         PORTB=0xaa;
	LDI  R30,LOW(170)
	RCALL SUBOPT_0x1
...
; .FSTART _ext_int1_isr
	RCALL SUBOPT_0x0
; 0000 002D         PORTB = 0x00; delay_ms(500);
	RCALL SUBOPT_0x2
; 0000 002E         PORTB=0xff; delay_ms(100);
; 0000 002F 
; 0000 0030         PORTB = 0x00; delay_ms(500);
	RCALL SUBOPT_0x2
; 0000 0031         PORTB=0xff; delay_ms(100);
; 0000 0032 
; 0000 0033         PORTB = 0x00; delay_ms(500);
	RCALL SUBOPT_0x2
; 0000 0034         PORTB=0xff; delay_ms(100);
; 0000 0035 
; 0000 0036 }
_0x10:
	LD   R30,Y+
...
_main:
; .FSTART _main
; 0000 003A unsigned char led=0xff;
; 0000 003B int i;
; 0000 003C 
...
; 0000 00B8 // INT0: On
; 0000 00B9 // INT0 Mode: Low level
; 0000 00BA // INT1: On
; 0000 00BB // INT1 Mode: Low level
; 0000 00BC // INT2: Off
; 0000 00BD // INT3: Off
; 0000 00BE // INT4: Off
; 0000 00BF // INT5: Off
...
; 0000 00C9 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	LDI  R30,LOW(0)
	OUT  0xA,R30
; 0000 00CA 
...
; 0000 00DA ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00DB 
...
_0xA:
	...
	BRGE _0xB
; 0000 00EB         {
; 0000 00EC             PORTB=led; delay_ms(300); led=(led<<1|0x01);
	RCALL SUBOPT_0x3
	LSL  R30
	ORI  R30,1
	MOV  R17,R30
...
; 0000 00EE       led=0x7f;
	LDI  R17,LOW(127)
; 0000 00EF         for(i=0;i<8;i++)
	__GETWRN 18,19,0
_0xD:
	__CPWRN 18,19,8
	BRGE _0xE
; 0000 00F0         {
; 0000 00F1             PORTB=led; delay_ms(300); led=(led>>1|0x80) ;
	RCALL SUBOPT_0x3
	LSR  R30
	ORI  R30,0x80
	MOV  R17,R30
